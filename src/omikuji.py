...
class Omikuji:
    ...
    FORTUNE_ADVICE: Dict[FortuneLevel, str] = {
        FortuneLevel.DAIKICHI: "今日は非常に良い日です。\n自信を持って行動しましょう！",
        FortuneLevel.CHUKICHI: "今日は良い日ですが、\n慎重さも忘れずに。",
        FortuneLevel.SHOKICHI: "まあまあの運勢です。\nちょっとしたラッキーがあります。",
        FortuneLevel.KICHI: "運勢は良いですが、\n油断は禁物。",
        FortuneLevel.KYO: "今日は気をつけて行動しましょう。\n無理をしないのが吉。",
...
def draw() -> Fortune:
    ...
    result = random.choices(
        list(Omikuji.FORTUNE_WEIGHTS.keys()),
        weights=list(Omikuji.FORTUNE_WEIGHTS.values()),
    )[0]
